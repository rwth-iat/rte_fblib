...
OV_DLLFNCEXPORT OV_RESULT iec61131stdfb_LEFT_IN_set(
    OV_INSTPTR_iec61131stdfb_LEFT          pobj,
    const OV_STRING  value
) {
    return ov_string_setvalue(&pobj->v_IN,value);
}

OV_DLLFNCEXPORT OV_RESULT iec61131stdfb_LEFT_L_set(
    OV_INSTPTR_iec61131stdfb_LEFT          pobj,
    const OV_UINT  value
) {
    pobj->v_L = value;
...
OV_DLLFNCEXPORT OV_STRING iec61131stdfb_LEFT_OUT_get(
    OV_INSTPTR_iec61131stdfb_LEFT          pobj
) {
    return pobj->v_OUT;
}
...
OV_DLLFNCEXPORT void iec61131stdfb_LEFT_typemethod(
    ...
    */
    ...
    OV_INSTPTR_iec61131stdfb_LEFT pinst = Ov_StaticPtrCast(iec61131stdfb_LEFT, pfb);
	
	ov_string_setvalue(&pinst->v_OUT, "");	//free memory
	if(pinst->v_L <= ov_string_getlength(pinst->v_IN))
	{
		p_char = (OV_STRING) ov_malloc((pinst->v_L + 1) * sizeof(char));
		if(p_char != NULL)
		{
			for(i=0; i < pinst->v_L; i++)
				p_char[i] = pinst->v_IN[i];
			p_char[pinst->v_L] = 0;
